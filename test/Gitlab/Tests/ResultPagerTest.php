...
use Gitlab\Tests\Mock\TestResponse;
...
class ResultPagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function shouldGetAllResults()
    {
        ...
        // memberApi Mock
        $memberApiMock = $this->getApiMock('Gitlab\Api\Organization\Members');
        $memberApiMock
            ->expects($this->once())
            ->method('all')
        ...
        $paginator = new Gitlab\ResultPager($clientMock);
    ...
    public function shouldGetSomeResults()
    {
        ...
        $organizationApiMock = $this->getApiMock('Gitlab\Api\Organization');
        ...
        $paginator = new Gitlab\ResultPager($client);
...
TEXT;
    ...
    protected function getClientMock(HttpClientInterface $httpClient = null)
    {
        ...
        $client = new \Gitlab\Client($httpClient);
    ...
    protected function getHttpClientMock($responseMock = null)
    {
        ...
        $httpClientMock = $this->getMock('Gitlab\HttpClient\HttpClient', array(), array(array(), $clientInterfaceMock));
