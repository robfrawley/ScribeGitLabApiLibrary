...
class ErrorListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @test
     * @expectedException \Gitlab\Exception\ApiLimitExceedException
     */
    ...
    /**
     * @test
     * @expectedException \Gitlab\Exception\RuntimeException
     */
    ...
    /**
     * @test
     * @expectedException \Gitlab\Exception\ErrorException
     */
     ...
     * @expectedException \Gitlab\Exception\ValidationFailedException
     */
