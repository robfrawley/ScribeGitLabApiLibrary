...
class PullRequestTest extends TestCase
{
    ...
    public function shouldCreatePullRequestUsingTitle()
    {
        $data = array(
            ...
            'title' => 'TITLE: Testing pull-request creation from PHP Gitlab API',
            'body'  => 'BODY: Testing pull-request creation from PHP Gitlab API'
        );
    ...
    public function shouldGetCommentsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\PullRequest\Comments', $api->comments());
    }

    protected function getApiClass()
    {
        return 'Gitlab\Api\PullRequest';
    }
}
