...
class RepoTest extends TestCase
{
    ...
    public function shouldGetCollaboratorsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Collaborators', $api->collaborators());
    }
    ...
    public function shouldGetCommentsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Comments', $api->comments());
    }
    ...
    public function shouldGetCommitsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Commits', $api->commits());
    }
    ...
    public function shouldGetContentsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Contents', $api->contents());
    }
    ...
    public function shouldGetDeployKeysApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\DeployKeys', $api->keys());
    }
    ...
    public function shouldGetDownloadsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Downloads', $api->downloads());
    }
    ...
    public function shouldGetForksApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Forks', $api->forks());
    }
    ...
    public function shouldGetHooksApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Hooks', $api->hooks());
    }
    ...
    public function shouldGetLabelsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Labels', $api->labels());
    }
    ...
    public function shouldGetStatusesApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Statuses', $api->statuses());
    }
    ...
    public function shouldGetReleasesApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Repository\Releases', $api->releases());
    }
