...
class AbstractApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return new \Gitlab\Client($this->getHttpMock());
    }

    /**
     * @return \Gitlab\HttpClient\HttpClientInterface
     */
    protected function getHttpMock()
    {
        return $this->getMock('Gitlab\HttpClient\HttpClient', array(), array(array(), $this->getHttpClientMock()));
    }
