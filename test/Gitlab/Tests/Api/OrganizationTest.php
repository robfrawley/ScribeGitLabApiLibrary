...
class OrganizationTest extends TestCase
{
    ...
    public function shouldGetMembersApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Organization\Members', $api->members());
    }
    ...
    public function shouldGetTeamsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Organization\Teams', $api->teams());
    }

    protected function getApiClass()
    {
        return 'Gitlab\Api\Organization';
    }
}
