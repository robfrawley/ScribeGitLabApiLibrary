...
class IssueTest extends TestCase
{
    ...
    public function shouldGetCommentsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Issue\Comments', $api->comments());
    }
    ...
    public function shouldGetEventsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Issue\Events', $api->events());
    }
    ...
    public function shouldGetLabelsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Issue\Labels', $api->labels());
    }
    ...
    public function shouldGetMilestonesApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\Issue\Milestones', $api->milestones());
    }

    protected function getApiClass()
    {
        return 'Gitlab\Api\Issue';
    }
}
