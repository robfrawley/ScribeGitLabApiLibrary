...
class CurrentUserTest extends TestCase
{
    ...
    public function shouldGetDeployKeysApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\CurrentUser\DeployKeys', $api->keys());
    }
    ...
    public function shouldGetEmailsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\CurrentUser\Emails', $api->emails());
    }
    ...
    public function shouldGetFollowersApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\CurrentUser\Followers', $api->follow());
    }
    ...
    public function shouldGetNotificationsApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\CurrentUser\Notifications', $api->notifications());
    }
    ...
    public function shouldGetWatchersApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\CurrentUser\Watchers', $api->watchers());
    }
    ...
    public function shouldGetStarredApiObject()
    {
        ...
        $this->assertInstanceOf('Gitlab\Api\CurrentUser\Starring', $api->starring());
    }

    protected function getApiClass()
    {
        return 'Gitlab\Api\CurrentUser';
    }
}
